...
import com.gohardvpn.plus.AppConfig.DEFAULT_PORT
import com.gohardvpn.plus.AppConfig.PREF_ALLOW_INSECURE
import com.gohardvpn.plus.AppConfig.REALITY
import com.gohardvpn.plus.AppConfig.TLS
import com.gohardvpn.plus.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.gohardvpn.plus.AppConfig.WIREGUARD_LOCAL_MTU
...
class ServerActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layoutId = when (config?.configType ?: createConfigType) {
            ...
            EConfigType.SOCKS, EConfigType.HTTP, EConfigType.SSH -> R.layout.activity_server_socks
    ...
    private fun saveServer(): Boolean {
        ...
        if (config.configType != EConfigType.SOCKS
            ...
            && config.configType != EConfigType.SSH
