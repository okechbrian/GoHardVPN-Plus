...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/okechbrian/GoHardVPN-Plus"
    const val APP_API_URL = "https://api.github.com/repos/okechbrian/GoHardVPN-Plus/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/okechbrian/GoHardVPN-Plus/master/CR.md"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val RAY_NG_CHANNEL_ID = "GO_HARD_VPN_M_CH_ID"
    const val RAY_NG_CHANNEL_NAME = "GoHardVPN Background Service"
